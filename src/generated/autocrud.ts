...
> = {
  organisation: {
    Object: organisation.organisationObject,
    queries: {
      findFirst: organisation.findFirstorganisationQueryObject,
      findMany: organisation.findManyorganisationQueryObject,
      count: organisation.countorganisationQueryObject,
      findUnique: organisation.findUniqueorganisationQueryObject,
    },
    mutations: {
      createMany: organisation.createManyorganisationMutationObject,
      createOne: organisation.createOneorganisationMutationObject,
      deleteMany: organisation.deleteManyorganisationMutationObject,
      deleteOne: organisation.deleteOneorganisationMutationObject,
      updateMany: organisation.updateManyorganisationMutationObject,
      updateOne: organisation.updateOneorganisationMutationObject,
      upsertOne: organisation.upsertOneorganisationMutationObject,
    },
  },
};
